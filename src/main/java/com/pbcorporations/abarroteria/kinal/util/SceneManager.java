...
import main.java.com.pbcorporations.abarroteria.kinal.controller.ClienteController;
...
public class SceneManager {
    ...
    public void showClienteView() throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource(FXML_PATH + "cliente-view.fxml"));

        loader.setControllerFactory(
                clazz -> {
                    if (clazz == ClienteController.class) {
                        ClienteRepository repository = new ClienteRepository();
                        ClienteService service = new ClienteService(repository);
                        return new ClienteController(service, this);
                    }
